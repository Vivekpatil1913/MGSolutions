...
const states = [
  {
    ...
    desc:
      "Rajasthan which is known for it’s warm hospitality and rich culture is one of the very few states which allows the company setting up an industrial unit in the State to choose from the different forms of subsidies",
    details: `
...

   {
    ...
    desc:
      "Maharashtra which is one the most industrialised states in the country is not known to be a Startup Hub but it has come out with a unique incentive for Startups & MSMEs who list on the SME stock exchange at BSE / NSE by reimbursing upto Rs.6 lac towards listing cost which includes professional fees by Chartered Accountant / Consultant as also official listing fee."
  },
...

{
    ...
    desc:
      "Andhra Pradesh has consistently been ranked no. 1 in India for Ease of Doing Business and ranked no. 4 in terms of number of factories and no. 7 in terms of industrial output. AP has a hassle free land allotment process and they guarantee to allot land for industrial purposes within 21 days of receipt of application for the same."
  }, 

  {
...

   {
    ...
    desc:
      "Gujarat has emerged as a mega power house of industrial units especially a major automobile hub. It has a unique sustenance scheme for startups of Rs.20,000 per month for a period of one year and Rs.25,000 per month for women led startups."
  }, 
    ...
    desc:
      "Madhya Pradesh strategically located in Central India and has a rewarding policy whereby capital subsidy of 40% is provided across any industry setup in the State upto a capital value of Rs.10 crore and irrespective of the size of the company."
  },
      ...
      <div className="modal-content">
        ...
        <div className="modal-info">
          <p style={{ whiteSpace: "pre-line" }}>
            {activeState.details || activeState.desc}
          </p>
        </div>
      </div>
    </div>
