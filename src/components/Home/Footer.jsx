    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="footer-col">
          ...
          <p>
            Subsidy4India is a one-stop platform for <br></br> all Central &
            State Government subsidies <br></br>in India.
          </p>
      ...
      <div className="footer-bottom">
        Copyright © 2025 <span className="footer-company">
